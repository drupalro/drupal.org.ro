 ...
 */
function drupalro_preprocess_html(&$variables) {
 ...
 */
function drupalro_process_html(&$variables) {
 ...
 */
function drupalro_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function drupalro_preprocess_maintenance_page(&$variables) {
  ...
  drupal_add_css(drupal_get_path('theme', 'drupalro') . '/css/maintenance-page.css');
}

/**
 * Override or insert variables into the maintenance page template.
 */
function drupalro_process_maintenance_page(&$variables) {
  // Always print the site name and slogan, but if they are toggled off, we'll
  // just hide them visually.
  $variables['hide_site_name']   = theme_get_setting('toggle_name') ? FALSE : TRUE;
  $variables['hide_site_slogan'] = theme_get_setting('toggle_slogan') ? FALSE : TRUE;
 ...
 */
function drupalro_preprocess_block(&$variables) {
 ...
 */
function drupalro_menu_tree($variables) {
 ...
 */
function drupalro_field__taxonomy_term_reference($variables) {
  $output = '';
